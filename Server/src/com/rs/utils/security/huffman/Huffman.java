package com.rs.utils.security.huffman;
...
public final class Huffman {
	...
	public static int encryptMessage(int streamOffset,
	...
	public static String readEncryptedMessage(int maxLength,
                                              InputStream stream) {
		try {
			...
			return Utils.getUnformatedMessage(messageDataLength, 0,
					messageData);
		} catch (Throwable exception) {
			return "";
		}
