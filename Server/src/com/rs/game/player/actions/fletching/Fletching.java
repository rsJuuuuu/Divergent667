...
public class Fletching extends Action {
    ...
    public enum Fletch {
        ...
        REGULAR_BOW(1511, 946, new int[]{52, 50, 48, 9440}, new int[]{1, 5, 10, 9}, new double[]{0.33, 5, 10, 6}, new
                Animation(6702)),
        ...
        OAK_BOW(1521, 946, new int[]{54, 56, 9442}, new int[]{20, 25, 24}, new double[]{16.5, 25, 16}, new Animation
                (6702)),
        ...
        WILLOW_BOW(1519, 946, new int[]{60, 58, 9444}, new int[]{35, 40, 39}, new double[]{33.3, 41.5, 22}, new
                Animation(6702)),
        ...
        MAPLE_BOW(1517, 946, new int[]{64, 62, 9448}, new int[]{50, 55, 54}, new double[]{50, 58.3, 32}, new
                Animation(6702)),
        ...
        YEW_BOW(1515, 946, new int[]{68, 66, 9452}, new int[]{65, 70, 69}, new double[]{67.5, 75, 50}, new Animation
                (6702)),
         ...
         * Arrows
         */
        HEADLESS_ARROWS(52, 314, new int[]{53}, new int[]{1}, new double[]{15}, new Animation(-1)),
    ...
    public boolean start(Player player) {
        if (option >= fletch.getProduct().length) return false;
        if (!process(player)) return false;
        player.getPackets().sendGameMessage("You attempt to create a " + new Item(fletch.getProduct()[option])
                .getDefinitions().getName().replace("(u)", "") + "...", true);
        return true;
    }
    ...
    public boolean process(Player player) {
        ...
        if (!player.getInventory().containsItem(fletch.getId(), 1) || !player.getInventory().containsItem(fletch
                .getSelected(), 1))
            return false;
    ...
    public int processWithDelay(Player player) {
        ...
        player.getPackets().sendGameMessage("You successfully create a " + new Item(fletch.getProduct()[option])
                .getDefinitions().getName().replace("(u)", "") + ".", true);
    ...
    public static Fletch isFletching(Item first, Item second) {
        ...
        int selected;
        if (fletch != null) selected = second.getId();
        else {
