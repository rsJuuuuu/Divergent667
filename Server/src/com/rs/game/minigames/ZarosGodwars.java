...
public final class ZarosGodwars {
                ...
                WorldTasksManager.schedule(new WorldTask() {
                    ...
                    public void run() {
                        ...
                        if (count == 1) {
                            ...
                            nex.setNextFaceWorldTile(new WorldTile(fumus.getCoordFaceX(fumus.getSize()), fumus
                            ...
                            nex.setNextFaceWorldTile(new WorldTile(umbra.getCoordFaceX(umbra.getSize()), umbra
                            ...
                            nex.setNextFaceWorldTile(new WorldTile(cruor.getCoordFaceX(cruor.getSize()), cruor
    ...
    private static final Rectangle LAIR = new Rectangle(2910, 5186, 2942, 5220);

    public static boolean isInsideLair(Player player) {
        return LAIR.contains(player);
    }
}
