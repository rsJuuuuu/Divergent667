...
public class Class157
{
	...
	static final void method1710(int i, int i_2_, boolean bool, int i_3_, int i_4_, int i_5_) {
		...
		if (Class175.aClass261ArrayArrayArray2099 == null) {
			...
			if (aa.anInt101 == 0) {
				if (Class295.myPlayer.anInt5934 < 0 || 512 * Node_Sub54.GAME_SCENE_WDITH <= Class295.myPlayer.anInt5934 || Class295.myPlayer.anInt5940 < 0 || Class295.myPlayer.anInt5940 >= Class377_Sub1.GAME_SCENE_HEIGHT * 512) {
					bool_6_ = true;
				}
			...
			if (bool_6_) {
				...
				Class110.anInt1412++;
				if (Class295.myPlayer != null && Class359.anInt4467 == Class295.myPlayer.anInt5934 + (-(256 * Class295.myPlayer.getSize((byte) 45)) + 256) >> 9 && Node_Sub15_Sub4.anInt9798 == Class295.myPlayer.anInt5940 + -(256 * (Class295.myPlayer.getSize((byte) 48) + -1)) >> 9) {
				...
				} else if (Class245.aClass119_3085 == null) {
					Class93.aGraphicsToolkit1241.GA(i_18_);
					Class93.aGraphicsToolkit1241.ya();
				} else {
				...
				if (Class71.aBoolean967) {
					...
					Class151.method1671(Class174.clientCycle, Class98.anInt5061, Class190.anInt2331, Node_Sub10.anInt7079, Node_Sub38_Sub15.aByteArrayArrayArray10261, Class259.anIntArray3296, MainFile.anIntArray135, Class246.anIntArray3107, Class84.anIntArray1147, Class362.anIntArray4497, 1 + Class295.myPlayer.plane, b, Class295.myPlayer.anInt5934 >> 9, Class295.myPlayer.anInt5940 >> 9, Class213.aNode_Sub27_2512.aClass320_Sub8_7280.method3712(false) == 0, true, !Node_Sub15_Sub10.aBoolean9850 ? -1 : Class308.anInt3912, 0, false);
				}
				CacheNode_Sub16_Sub1.method2387((byte) -114);
