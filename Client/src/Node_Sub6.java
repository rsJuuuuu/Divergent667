...
public class Node_Sub6 extends Node
{
	...
	static final void method2416(int i, int i_0_, IComponentDefinitions[] widgets, int i_1_, int i_2_, int i_3_, int i_4_, boolean bool, int i_5_, int i_6_, int i_7_) {
		...
		for (int i_8_ = 0; i_8_ < widgets.length; i_8_++) {
			...
			if (widget != null && (i == widget.parentId || i == -1412584499 && Class58.aWidget861 == widget)) {
				...
				if (!Client.method112(widget)) {
					...
					if (Class54.aBoolean817 && (Client.method113(widget).settingsHash != 0 || widget.type == 0) && i_18_ > 127) {
						i_18_ = 127;
					}
						...
						if (widget.type == 0) {
							...
							if (Class193.anInt2368 == widget.anInt4814) {
								...
								if (aa.anInt101 == 3) {
									...
									if (Class1.anInt115 > Class174.clientCycle) {
										...
										i_43_ = (int) (f * (float) Animable_Sub4.anInt9153 + (1.0F - f) * (float) BufferedStream.anInt7023);
									}
									if (i_40_ > 0) {
							...
							if (widget.type == 3) {
								...
								if (class52 == null) {
									...
									if (widget.anInt4718 != -1) {
										ItemDefinitions itemdefinition = EntityNode_Sub3_Sub1.aClass86_9166.method1010(widget.anInt4718, 14434);
									...
									if (glsprite == null) {
										...
										if (widget.aBoolean4861) {
											...
											if (widget.anInt4728 != 0) {
												...
												glsprite.setPosition(i_14_, i_15_);
											}
								...
								if (widget.anInt4718 == -1) {
									if (widget.modelType == 5) {
										...
										if (i_55_ >= 0 && i_55_ < 2048) {
											...
											if (player != null && (i_55_ == Class166.myPlayerIndex || widget.anInt4683 == Class51_Sub1.method522(player.username, (byte) -104))) {
	...
	Node_Sub6(byte[] bs) {
		...
		buffer.offset += i_74_;
		int i_78_;
		for (i_78_ = 0; buffer.buffer[i_78_ + buffer.offset] != 0; i_78_++) {
			/* empty */
		}
		...
		int i_91_;
		for (i_91_ = 0; buffer.buffer[i_91_ + buffer.offset] != 0; i_91_++) {
			/* empty */
		}
