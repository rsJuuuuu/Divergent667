...
public class Node_Sub38_Sub19 extends Node_Sub38
{
	...
	static final boolean method2849(int i, int i_1_, Class261[][][] class261s, int i_2_, int i_3_, boolean bool) {
		...
		if (b == Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_3_][i_1_]) {
			return false;
		}
		...
		while (i_5_ != i_6_) {
			...
			if ((CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 0x4) == 0) {
				bool_12_ = true;
			}
			...
			if (!bool_12_) {
				if (i_7_ >= 1 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_]) {
				...
				if (++i_10_ < Class377_Sub1.GAME_SCENE_HEIGHT) {
					if (i_7_ - 1 >= 0 && Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_] != b && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 0x4) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + -1][-1 + i_10_] & 0x4) == 0) {
				...
				if (--i_10_ >= 0) {
					if (i_7_ - 1 >= 0 && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ - 1][i_10_] && (0x4 & CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_]) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][-1 + i_7_][i_10_ + 1] & 0x4) == 0) {
					...
					if (i_7_ + 1 < Node_Sub54.GAME_SCENE_WDITH && b != Node_Sub38_Sub15.aByteArrayArrayArray10261[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ + 1][i_10_] && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_][i_10_] & 0x4) == 0 && (CacheNode_Sub11.aByteArrayArrayArray9550[CacheNode_Sub20_Sub1.myPlayerPlane][i_7_ - -1][1 + i_10_] & 0x4) == 0) {
